...
c = Car("Ford", "Mustang", "Black", "V6", "Unleaded", "2-door",['power mirrors', 'power locks', 'remote start','backup camera','Bluetooth','cruise control'])

t = Truck("Ford","F-150","Blue","Diesel","Regular","Extended",['Bluetooth','Stereo'])
...
while i == 1:
    ...
    if choice == 1:
        ...
        t1 = Truck(make, model, color, fuelType, cabStyle, bedLength, options)
